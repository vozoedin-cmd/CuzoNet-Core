...
/**
 * Stable business identifier for a RouterOS firewall Mangle rule. Embedded
 * in the rule's comment marker (see MangleRuleComment) so identity never
 * depends on RouterOS's mutable ".id", which can change after exports,
 * restores or recreations.
 */
export class MangleRuleReference {
  private constructor(public readonly value: string) {}

  public static create(raw: string): MangleRuleReference {
    ...
    return new MangleRuleReference(value);
  }
}
