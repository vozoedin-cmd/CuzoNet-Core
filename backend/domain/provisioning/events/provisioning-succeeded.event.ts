...
export interface ProvisioningSucceededEventProps {
  aggregateId: string;
  causationId: string;
...
export class ProvisioningSucceededEvent {
  public readonly aggregateType = 'ProvisioningRequest';
  public readonly eventType = 'ProvisioningSucceeded.v1';
  ...
  public constructor(props: ProvisioningSucceededEventProps) {
