...
export interface ProvisioningFailedEventProps {
  aggregateId: string;
  causationId: string;
...
export class ProvisioningFailedEvent {
  public readonly aggregateType = 'ProvisioningRequest';
  public readonly eventType = 'ProvisioningFailed.v1';
  ...
  public constructor(props: ProvisioningFailedEventProps) {
