...
export interface ProvisioningRequestedEventProps {
  aggregateId: string;
  causationId: string;
...
export class ProvisioningRequestedEvent {
  public readonly aggregateType = 'ProvisioningRequest';
  public readonly eventType = 'ProvisioningRequested.v1';
  ...
  public constructor(props: ProvisioningRequestedEventProps) {
